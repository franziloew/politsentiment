...
# load the dataframe
tweets <- read_csv("~/GitHub/politsentiment/data/tweets_18_24")
afd1 <- read_csv("~/GitHub/politsentiment/data/tweets_18_24_afd2")
afd2 <- read_csv("~/GitHub/politsentiment/data/tweets_18_24_afd3")
...
```{r, eval=FALSE, include=FALSE}
save(tweets, file = "~/GitHub/politsentiment/out/tweets_18_24.rda")
```

```{r, include=FALSE}
rm(list = ls())
load(file = "~/GitHub/politsentiment/out/tweets_18_24.rda")
...
vlabs[degree(rtnet, cmode = 'outdegree') < 2] = NA
...
news.token %>% 
  ...
  ggplot(aes(reorder(partei,Sentimentwert), Sentimentwert)) +
          xlab("") +
           geom_col(fill = c( "gold","red2","black","darkorchid2","deepskyblue1"), alpha = .8) 
...
user.token %>% 
  ...
  ggplot(aes(reorder(partei,Sentimentwert), Sentimentwert)) +
          xlab("") +
           geom_col(fill = c("deepskyblue1","black","red2","gold","darkorchid2"),alpha=.8) 
```
