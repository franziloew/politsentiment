...
gruene <- tweets[grepl(paste(c("gruene","grune","gruenen","grunen","ozdemir"), collapse = "|"), tweets$text_cleaned),]
...
vlabs[degree(rtnet, cmode = 'outdegree') < 4] = NA
...
news.token %>% 
  ...
  ggplot(aes(reorder(partei,Sentimentwert), Sentimentwert)) +
          xlab("") +
           geom_col(fill = c("black","darkorchid2", "gold","deepskyblue1","red2"), alpha = .8) 
