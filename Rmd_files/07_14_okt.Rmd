...
corp <- tm_map(corp, removeWords, c("cdu","spd","fdp","grünen","grüne","linke","dielinke","afd","gen","merkel","schulz","csu","union"))
...
# create corpus
corp <- Corpus(VectorSource(all))
corp <- tm_map(corp, removeWords, c("cdu","spd","fdp","grünen","grüne","linke","dielinke","afd","merkel","schulz","csu","union"))
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
ignore <- c("merkel","schulz", "cdu","spd","fdp","grüne","grünen","linke", "dielinke", "union")
