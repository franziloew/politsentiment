...
consumer_key <- 'FJHiSxWJAJlOHuRY4hgfjPdt9'
consumer_secret <- 'nMq8c2iNX9wqxzuFgGnsOqskimWeT0VCBJ7aRQcFIqoS2OK883'
access_token <- '2994024412-IMprLDKulBUoZieUyaA8QbZixV1pHqDxvrVXtPf'
access_secret <- 'QBHRBRGPDmkd1PfWEyX1rVgNihJmGp6qaSgEMHuz9mDEg'

setup_twitter_oauth(consumer_key, consumer_secret, access_token, access_secret)
```

```{r eval=FALSE, include=FALSE}
groko <- searchTwitter("groko", n=18000, lang = "de",
                       since = "2018-03-02",
                       until = "2018-03-06")

groko_df <- twListToDF(groko)

save(groko_df, file = "groko.Rda")
```
