...
tweets %>%
  filter(!grepl(paste(c("cdu","merkel","union","spd","schulz","fdp","lindner","gruene","grüne","ozdemir","bündnis","linke","wagenknecht","afd","gauland"), collapse = "|"), tweets$text_cleaned)) ->none
none$partei <- "None"
