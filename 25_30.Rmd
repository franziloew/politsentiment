...
# load the dataframe
tweets <- read_csv("~/GitHub/politsentiment/out/tweets_25_30")
...
```{r, eval=FALSE, include=FALSE}
save(tweets, rt, file = "~/GitHub/politsentiment/out/tweets_25_30.rda")
```

```{r, include=FALSE}
rm(list = ls())
load(file = "~/GitHub/politsentiment/out/tweets_25_30.rda")
